...
## Purpose
Record proposals, reviewer findings, decision owner, chosen option and rejected alternatives.
...
## Tests
- `test_decision_logging_schema`
- `test_decision_logging_boundary`
- `test_decision_logging_provenance`
