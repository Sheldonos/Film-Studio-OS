<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: motion-performance-planning. -->
---
skill_id: performance_prompting
name: Performance Prompting
...
## Purpose
Translate objective, tactic, tempo, gaze, gesture and emotional state into playable generation direction.
...
## Tests
- `test_performance_prompting_schema`
- `test_performance_prompting_boundary`
- `test_performance_prompting_provenance`
