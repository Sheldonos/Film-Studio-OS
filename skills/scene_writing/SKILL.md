...
## Purpose
Convert an approved scene card into visual, playable screenplay pages with late entry, turns and an active exit.
...
## Tests
- `test_scene_writing_schema`
- `test_scene_writing_boundary`
- `test_scene_writing_provenance`
