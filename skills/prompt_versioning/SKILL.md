...
## Purpose
Version compiled prompts and preserve field-level provenance back to structured source specs.
...
## Tests
- `test_prompt_versioning_schema`
- `test_prompt_versioning_boundary`
- `test_prompt_versioning_provenance`
