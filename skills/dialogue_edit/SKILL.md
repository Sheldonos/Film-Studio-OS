...
## Purpose
Clean, select and align dialogue takes while preserving performance continuity.
...
## Tests
- `test_dialogue_edit_schema`
- `test_dialogue_edit_boundary`
- `test_dialogue_edit_provenance`
