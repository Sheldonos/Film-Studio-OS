...
## Purpose
Translate scene objective, tempo, palette, arc and hit points into a composer/generator-ready brief.
...
## Tests
- `test_cue_brief_schema`
- `test_cue_brief_boundary`
- `test_cue_brief_provenance`
