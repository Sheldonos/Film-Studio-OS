<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: continuity-qc. -->
---
skill_id: continuity_qc
name: Continuity QC
...
## Purpose
Validate selected media against authoritative continuity state and adjacent shots.
...
## Tests
- `test_continuity_qc_schema`
- `test_continuity_qc_boundary`
- `test_continuity_qc_provenance`
