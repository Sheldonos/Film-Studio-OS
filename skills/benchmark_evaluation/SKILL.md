<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: quality-gate-design. -->
---
skill_id: benchmark_evaluation
...
## Purpose
Run repeatable screenplay, shot and studio-orchestration regression fixtures.
...
## Tests
- `test_benchmark_evaluation_schema`
- `test_benchmark_evaluation_boundary`
- `test_benchmark_evaluation_provenance`
