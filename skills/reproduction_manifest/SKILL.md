<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: archive-reproduction. -->
---
skill_id: reproduction_manifest
...
## Purpose
Emit exact recipe for regenerating an internally produced artifact where provider determinism permits.
...
## Tests
- `test_reproduction_manifest_schema`
- `test_reproduction_manifest_boundary`
- `test_reproduction_manifest_provenance`
