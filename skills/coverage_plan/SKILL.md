...
## Purpose
Choose masters, singles, reactions, inserts and transitions based on edit/narrative needs.
...
## Tests
- `test_coverage_plan_schema`
- `test_coverage_plan_boundary`
- `test_coverage_plan_provenance`
