...
## Purpose
Diagnose premise, setup, turn, escalation, button and consequence of comic lines.
...
## Tests
- `test_joke_mechanics_schema`
- `test_joke_mechanics_boundary`
- `test_joke_mechanics_provenance`
