<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: documentary-evidence. -->
---
skill_id: rights_risk_triage
name: Rights / Clearance Risk Triage
department: studio_governance
owner_agent: studio_orchestrator
version: 0.1.0
---

# Rights / Clearance Risk Triage

## Purpose
Flag possible rights, likeness, trademark, music and source-material risks for human/legal review; never declares legal clearance.
...
## Tests
- `test_rights_risk_triage_schema`
- `test_rights_risk_triage_boundary`
- `test_rights_risk_triage_provenance`
