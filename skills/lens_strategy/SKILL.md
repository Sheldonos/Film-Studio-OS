...
## Purpose
Choose focal-length family and perspective behavior consistent with visual intent.
...
## Tests
- `test_lens_strategy_schema`
- `test_lens_strategy_boundary`
- `test_lens_strategy_provenance`
