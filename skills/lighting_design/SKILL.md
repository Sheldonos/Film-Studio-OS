...
## Purpose
Specify motivated key/fill/back, contrast, direction, quality, color temperature and practical sources.
...
## Tests
- `test_lighting_design_schema`
- `test_lighting_design_boundary`
- `test_lighting_design_provenance`
