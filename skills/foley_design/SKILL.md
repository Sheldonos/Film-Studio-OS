...
## Purpose
Design sync-specific footsteps, cloth, props and body movement that make generated images feel physical.
...
## Tests
- `test_foley_design_schema`
- `test_foley_design_boundary`
- `test_foley_design_provenance`
