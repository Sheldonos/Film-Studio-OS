...
## Purpose
Translate shot specs into board frames emphasizing geography, pose, composition and transitions.
...
## Tests
- `test_storyboard_plan_schema`
- `test_storyboard_plan_boundary`
- `test_storyboard_plan_provenance`
