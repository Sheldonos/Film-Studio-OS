...
## Purpose
Create thematic musical identities that can develop with character/story state.
...
## Tests
- `test_motif_design_schema`
- `test_motif_design_boundary`
- `test_motif_design_provenance`
