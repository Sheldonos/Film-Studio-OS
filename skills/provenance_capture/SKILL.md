...
## Purpose
Record inputs, model/provider, parameters, references, agent, time, decisions and output hashes for each artifact.
...
## Tests
- `test_provenance_capture_schema`
- `test_provenance_capture_boundary`
- `test_provenance_capture_provenance`
