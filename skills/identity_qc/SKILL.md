...
## Purpose
Validate face/body/wardrobe/voice identity against canonical character state.
...
## Tests
- `test_identity_qc_schema`
- `test_identity_qc_boundary`
- `test_identity_qc_provenance`
