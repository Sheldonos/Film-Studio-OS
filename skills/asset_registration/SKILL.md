<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: source-intake-rights. -->
---
skill_id: asset_registration
...
## Purpose
Assign stable IDs, hashes, type, ownership, version and dependency metadata to all production assets.
...
## Tests
- `test_asset_registration_schema`
- `test_asset_registration_boundary`
- `test_asset_registration_provenance`
