...
## Purpose
Remove redundant intent, duplicate image information and generic filler without erasing voice.
...
## Tests
- `test_line_compression_schema`
- `test_line_compression_boundary`
- `test_line_compression_provenance`
