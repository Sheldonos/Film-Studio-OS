...
## Purpose
Build a complete scene/sequence assembly before polishing individual moments.
...
## Tests
- `test_assembly_edit_schema`
- `test_assembly_edit_boundary`
- `test_assembly_edit_provenance`
