...
## Purpose
Rank revision work by root cause, severity, blast radius and expected improvement.
...
## Tests
- `test_revision_plan_schema`
- `test_revision_plan_boundary`
- `test_revision_plan_provenance`
