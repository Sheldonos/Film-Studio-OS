...
## Purpose
Validate repaired frames against source motion, lighting, grain, identity and continuity.
...
## Tests
- `test_vfx_review_schema`
- `test_vfx_review_boundary`
- `test_vfx_review_provenance`
