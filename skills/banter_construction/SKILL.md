<!-- LEGACY RUNTIME CATALOG: not IBM Bob activation. Active parent: comedy-banter. -->
---
skill_id: banter_construction
name: Banter Construction
...
## Purpose
Build asymmetric volleys from relationship history, status and tactical play rather than interchangeable jokes.
...
## Tests
- `test_banter_construction_schema`
- `test_banter_construction_boundary`
- `test_banter_construction_provenance`
